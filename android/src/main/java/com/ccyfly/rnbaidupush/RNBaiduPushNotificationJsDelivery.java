...
public class RNBaiduPushNotificationJsDelivery {
    private ReactApplicationContext mReactContext;

    public RNBaiduPushNotificationJsDelivery(ReactApplicationContext reactContext) {
    ...
    void notifyNotification(Bundle bundle) {
        ...
        sendEvent("baiduNotificationReceived", params);
    }
